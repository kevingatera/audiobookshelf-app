<template>
  <!-- UX-FIX: min 44px touch target -->
  <button class="icon-btn rounded-md flex items-center justify-center px-2 relative min-h-[44px] min-w-[44px]" :class="borderless ? '' : 'bg-primary border border-warm'" @click="clickBtn">
